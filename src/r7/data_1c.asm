...
StageChunks:
	incbin	"src/maps/r7/chunks_1c.bin"
...
StageCollision:
	incbin	"src/maps/r7/collision_1c.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r7/foreground_1c.bin"
	even

StageMapBg:
	incbin	"src/maps/r7/background_1c.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r7/blocks_1c.nem"
	even

StageGfx:
	incbin	"src/maps/r7/gfx_1c.nem"
	even
