...
StageChunks:
	incbin	"src/maps/r3/chunks_1c.bin"
	even
...
StageCollision:
	incbin	"src/maps/r3/collision_1c.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r3/foreground_1c.bin"
	even

StageMapBg:
	incbin	"src/maps/r3/background_1c.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r3/blocks_1c.nem"
	even

StageGfx:
	incbin	"src/maps/r3/gfx_1c.nem"
	even
