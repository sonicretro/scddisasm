...
StageChunks:
	incbin	"src/maps/r6/chunks_1b.bin"
...
StageCollision:
	incbin	"src/maps/r6/collision_1b.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r6/foreground_1b.bin"
	even

StageMapBg:
	incbin	"src/maps/r6/background_1b.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r6/blocks_1b.nem"
	even

StageGfx:
	incbin	"src/maps/r6/gfx_1b.nem"
	even
