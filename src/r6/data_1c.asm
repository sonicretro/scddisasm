...
StageChunks:
	incbin	"src/maps/r6/chunks_1c.bin"
...
StageCollision:
	incbin	"src/maps/r6/collision_1c.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r6/foreground_1c.bin"
	even

StageMapBg:
	incbin	"src/maps/r6/background_1c.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r6/blocks_1c.nem"
	even

StageGfx:
	incbin	"src/maps/r6/gfx_1c.nem"
	even
