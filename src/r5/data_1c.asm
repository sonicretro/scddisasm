...
StageChunks:
	incbin	"src/maps/r5/chunks_1c.bin"
...
StageCollision:
	incbin	"src/maps/r5/collision_1c.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r5/foreground_1c.bin"
	even

StageMapBg:
	incbin	"src/maps/r5/bg_inside_1c.bin"
	even

StageMapBg2:
	incbin	"src/maps/r5/bg_outside_1c.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r5/blocks_1c.nem"
	even

StageGfx:
	incbin	"src/maps/r5/gfx_1c.nem"
	even
