...
StageChunks:
	incbin	"src/maps/r8/chunks_2c.bin"
	even
...
StageCollision:
	incbin	"src/maps/r8/collision_2c.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r8/foreground_2c.bin"
	even

StageMapBg:
	incbin	"src/maps/r8/background_2c.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r8/blocks_2c.nem"
	even

StageGfx:
	incbin	"src/maps/r8/gfx_2c.nem"
	even
